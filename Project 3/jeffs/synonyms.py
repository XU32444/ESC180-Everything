...
def run_similarity_test(filename, semantic_descriptors, similarity_fn):
    ...
    for e in range(len(biglist)):
        ans.append(most_similar_word(
            biglist[e][0], biglist[e][1:], semantic_descriptors, similarity_fn))
    return ans
...
# word = data_into_list[0]
# choices = set(data_into_list[1:])
# return most_similar_word(word, choices, semantic_descriptors, cosine_similarity)
